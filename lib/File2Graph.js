...
*/
	...
	var Spectra = function PcmImage( options ) {
		var i,
			self = this;
		this.options = {
			element: null,
	...
	Spectra.prototype.fireEvent = function ( eventName ) {
		...
		if ( !this.options.hasOwnProperty( methodName ) ) {
			...
			try {
				...
				throw new Error( 'Dynamic method "' + methodName + '" croaked with: ' + e );
			}
		}
	};

	Spectra.prototype.initGraphics = function () {
	...
	Spectra.prototype.load = function () {
		var self = this;
	...
	Spectra.prototype.clickedGraphic = function ( e ) {
	...
	Spectra.prototype.pause = function () {
		this._stop( true );
	};

	Spectra.prototype.stop = function () {
		this._stop( false );
	};

	Spectra.prototype._stop = function ( pause ) {
	...
	/**
            ...
            */
	Spectra.prototype.now = function () {
		return this.playbackTime + this.actx.currentTime - this._actxStartTime;
	};

	Spectra.prototype.play = function ( startAt ) {
	...
	Spectra.prototype.setNode = function () {
	...
	Spectra.prototype.graphComplete = function () {
		var self = this;
	...
	Spectra.prototype.storeCanvasImg = function () {
	...
	Spectra.prototype.replaceCanvasImg = function () {
